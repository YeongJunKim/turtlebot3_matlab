function [sub_measurement, local_main_position_sub1, local_sub_position_sub1, predict_next_local_main_position, flag_sub] = lidar_clustering_sub2(lidar_data_sub1, yaw_angle_sub1,f,h,x_sub_hat,control_commends )
 persistent firstRun 
 ...
 if isempty(firstRun)
     ...
     init_local_main_position = initial_position_main-initial_position_sub2;
%      init_local_sub_position = [tile_size*(0),tile_size*(-2)]';
     init_local_sub_position = initial_position_sub1 -initial_position_sub2;
