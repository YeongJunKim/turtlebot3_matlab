classdef turtle_bot_three < handle
    properties
        ...
        control_state_EKF_sub1 = zeros(3,1);
        control_sub1 = [];
        ...
        control_state_EKF_sub2 = zeros(3,1);
        control_sub2 = [];
...
%         v_angle_max = 1.30;
        ...
        pre_theta_sub2 =0;
        rotation_count_sub2 = 0;
        calibration_theta_sub2 = 0;
        
    end
    
    methods
        function obj = turtle_bot_three(ip, main_name, sub1_name, sub2_name, sampling_time)  % pub_name, param_fcn)
            rosshutdown;
            rosinit(ip);
...
%             [obj.control_publisher_sub2, obj.control_msg_sub2] = rospublisher('/tb3_2/cmd_vel', 'geometry_msgs/Twist');
            ...
            initial_position_main = [obj.tile_size*2, obj.tile_size*3]';
            initial_position_sub1 = [obj.tile_size*3, obj.tile_size*2]';
            initial_position_sub2 = [obj.tile_size*1 obj.tile_size*2]';
        ...
        function perception_fcn(obj)
            ...
            obj.serial_main = rossubscriber('main/read_waffle');
...
%             disp(obj.measurement_main)
            ...
            obj.yaw_angle_main = wrapToPi(obj.yaw_angle_main);
...
%                       
            ...
            %             disp(obj.x_main_hat_PEFFME)
%             obj.x_main_hat_EKF = Localization_main_EKF(obj.f_main,obj.Jacobian_F_main,obj.h_main,obj.Jacobian_H_main,obj.x_main_hat_EKF,z_main,obj.control_main);
...
%             obj.x_sub1_hat_EKF(1:3,1) = obj.x_main_hat_EKF;
            oneto360 = 1:360;
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% sub1 lidar process %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%              [obj.measurement_sub1, obj.local_main_position_sub1, obj.local_sub_position_sub1, obj.predict_next_local_main_position_sub1, obj.alpha_sub1] = lidar_clustering_sub1(obj.lidar_data_sub1, obj.yaw_angle_sub1,obj.f_sub,obj.h_sub,obj.x_sub1_hat_EKF, [obj.control_main' obj.control_sub1']');
            obj.plot_measurement_sub1 = [obj.x_main_hat_PEFFME(1)-obj.measurement_sub1(1) obj.x_main_hat_PEFFME(2)-obj.measurement_sub1(2)]';
%             obj.plot_measurement_sub1 = [obj.x_main_hat_EKF(1)-obj.measurement_sub1(1) obj.x_main_hat_EKF(2)-obj.measurement_sub1(2)]';
...
%             z_sub1_PEFFME = [obj.x_main_hat_EKF' obj.measurement_sub1(1,1:2) obj.calibration_theta_sub1]';
...
%             obj.x_sub1_hat_EKF = Localization_sub1_EKF(obj.f_sub,obj.Jacobian_F_sub,obj.h_sub,obj.Jacobian_H_sub,obj.x_sub1_hat_EKF,z_sub1_PEFFME,[obj.control_main' obj.control_sub1']');
...
%             obj.x_sub2_hat_EKF(1:3,1) = obj.x_main_hat_EKF;
            oneto360 = 1:360;
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% sub1 lidar process %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%            [obj.measurement_sub2, obj.local_main_position_sub2, obj.local_sub_position_sub2, obj.predict_next_local_main_position_sub2, obj.alpha_sub2] = lidar_clustering_sub2(obj.lidar_data_sub2, obj.yaw_angle_sub2,obj.f_sub,obj.h_sub,obj.x_sub2_hat_EKF, [obj.control_main' obj.control_sub2']');
             obj.plot_measurement_sub2 = [obj.x_main_hat_PEFFME(1)-obj.measurement_sub2(1) obj.x_main_hat_PEFFME(2)-obj.measurement_sub2(2)]'; 
%              obj.plot_measurement_sub2 = [obj.x_main_hat_EKF(1)-obj.measurement_sub2(1) obj.x_main_hat_EKF(2)-obj.measurement_sub2(2)]'; 
             if obj.measurement_sub2(1,3)-obj.pre_theta_sub2< -1 %&& obj.measurement_sub1(1,3)-obj.pre_theta_sub>0
                obj.rotation_count_sub2 = obj.rotation_count_sub2 +1;
            elseif obj.measurement_sub2(1,3)-obj.pre_theta_sub2 > 1
                obj.rotation_count_sub2 = obj.rotation_count_sub2 -1;
            end
            obj.calibration_theta_sub2 = obj.measurement_sub2(1,3) + 2*pi*obj.rotation_count_sub2;
            z_sub2_PEFFME = [obj.x_main_hat_PEFFME' obj.measurement_sub2(1,1:2) obj.calibration_theta_sub2]';
%             z_sub2_PEFFME = [obj.x_main_hat_EKF' obj.measurement_sub2(1,1:2) obj.calibration_theta_sub2]';
...
%             obj.x_sub2_hat_EKF = Localization_sub2_EKF(obj.f_sub,obj.Jacobian_F_sub,obj.h_sub,obj.Jacobian_H_sub,obj.x_sub2_hat_EKF,z_sub2_PEFFME,[obj.control_main' obj.control_sub2']');
            obj.pre_theta_sub2 = obj.measurement_sub2(1,3);
%                         obj.x_sub2_hat_PEFFME(4:6,1) = obj.real_sub2_state;
        ...
        function control_fcn(obj)
             ...
             x_ref = [obj.tile_size*7 obj.tile_size*7 0]';
             x_ref2 = [obj.tile_size*8 obj.tile_size*6 0]';
             x_ref3 = [obj.tile_size*6 obj.tile_size*6 0]';
%             circle_velocity = 1;
...
%             obj.xd = obj.tile_size*3;
%             obj.yd = obj.tile_size*5;
%             obj.xd_dot = 0;
%             obj.yd_dot = 0;
% % 
...
%             obj.control_state_EKF_sub1 = obj.x_sub1_hat_EKF(4:6,1);
%             obj.control_state_EKF_sub2 = obj.x_sub2_hat_EKF(4:6,1);
...
%             v_kinematic = Kinematic(obj.x_main_hat_EKF,x_ref);
%             v_kinematic2 = Kinematic2(obj.control_state_EKF_sub1,x_ref2);
%             v_kinematic3 = Kinematic3(obj.control_state_EKF_sub2,x_ref3);
            

%             if abs(obj.yaw_angle_main)<(3.14/2)
%                 constant_linear_input =0.0;
%                 constant_angular_input = 1.0;
%             else
...
%             disp(obj.control_msg_sub2.Linear.X)
...
%             head3 = scatter(obj.x_sub2_hat_PEFFME(4),obj.x_sub2_hat_PEFFME(5),'filled','MarkerFaceColor','g','MarkerEdgeColor','g');
%             head = scatter(obj.x_main_hat_EKF(1),obj.x_main_hat_EKF(2),'filled','MarkerFaceColor','r','MarkerEdgeColor','r'); hold on; grid on;
%             head2 = scatter(obj.x_sub1_hat_EKF(4),obj.x_sub1_hat_EKF(5),'filled','MarkerFaceColor','b','MarkerEdgeColor','b');
%             head3 = scatter(obj.x_sub2_hat_EKF(4),obj.x_sub2_hat_EKF(5),'filled','MarkerFaceColor','g','MarkerEdgeColor','g');
